...
dependencies {
    ...
    orchidRuntimeOnly("io.github.javaeden.orchid:OrchidJavadoc:0.20.0")
    orchidRuntimeOnly("io.github.javaeden.orchid:OrchidGroovydoc:0.20.0")
    orchidRuntimeOnly("io.github.javaeden.orchid:OrchidKotlindoc:0.20.0")
    orchidRuntimeOnly("io.github.javaeden.orchid:OrchidSwiftdoc:0.20.0")
